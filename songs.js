function zeldaTheme() {
    return [
        ...
        newTimedNote(Note.A, 5, 2 / 1),
        newPause(1 / 2),
        newTimedNote(Note.A, 5, 1 / 2),
        newTimedNote(Note.A, 5, 1 / 1 / 3),
        newTimedNote(Note.G, 5, 1 / 1 / 3),
        newTimedNote(Note.F, 5, 1 / 1 / 3),

        newTimedNote(Note.G, 5, (1 / 2) * 1.5),
        newTimedNote(Note.F, 5, 1 / 4),
        newTimedNote(Note.E, 5, 2 / 1),
        newTimedNote(Note.E, 5, 1 / 1),

        newTimedNote(Note.D, 5, 1 / 2),
        newTimedNote(Note.D, 5, 1 / 4),
        newTimedNote(Note.E, 5, 1 / 4),
        newTimedNote(Note.F, 5, 2 / 1),
        newTimedNote(Note.E, 5, 1 / 2),
        newTimedNote(Note.D, 5, 1 / 2),

        newTimedNote(Note.C, 5, 1 / 2),
        newTimedNote(Note.C, 5, 1 / 4),
        newTimedNote(Note.D, 5, 1 / 4),
        newTimedNote(Note.E, 5, 2 / 1),
        newTimedNote(Note.D, 5, 1 / 2),
        newTimedNote(Note.C, 5, 1 / 2),
        ...
        newTimedNote(Note.B, 4, 1 / 4),
        newTimedNote(Note.CSh, 5, 1 / 4),
        newTimedNote(Note.DSh, 5, 2 / 1),
        newTimedNote(Note.FSh, 5, 1 / 1),

        newTimedNote(Note.E, 5, 1 / 2),
        newTimedNote(Note.E, 4, 1 / 4),
        newTimedNote(Note.E, 4, 1 / 4),
